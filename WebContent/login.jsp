...
<body data-bs-spy="scroll" data-bs-target="#header-nav" tabindex="0">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-transparent  container-fluid py-3 position-fixed">
            ...
            <button class="navbar-toggler" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasNavbar"
                aria-controls="offcanvasNavbar">
                    ...
                    <div class="d-flex mt-5 mt-lg-0 ps-lg-3 align-items-center justify-content-center ">
                        ...
                        <a href="register.jsp"type="button" class="btn btn-primary ms-md-3"> Register </a>
                    </div>
        </div>
        ...
        <div class="container py-5 mt-5">
            <div class="row align-items-center py-5 mt-5">
                ...
                <div class="col-md-5 offset-md-1">
                    <form class="hero-form p-5" style="margin-top: 20px;" action="loginServlet" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" class="form-control border-0" id="password" placeholder="Votre mot de passe..." name="password">
                        </div>
                        <div class="d-grid">
                            <button type="submit" class="btn btn-primary btn-lg" value="Se connecter">Log In</button>
                        </div>
                    </form>
                </div>
            </div>
